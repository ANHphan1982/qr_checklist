  ...
  return (
    <div className="bg-blue-600 text-white px-4 py-3 flex items-center justify-between gap-3">
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        <button
          onClick={onInstall}
          className="px-4 py-2.5 bg-white text-blue-700 rounded-xl text-sm font-bold active:bg-blue-50 transition-colors min-h-[44px]"
        >
          Cài đặt
        </button>
        <button
          onClick={onDismiss}
          className="p-3 text-blue-200 hover:text-white transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center text-xl"
          aria-label="Bỏ qua"
        >
          ×
        </button>
...
function NavBar({ dark, onToggleDark }) {
  const base   = "px-5 py-3 rounded-xl text-base font-semibold transition-colors min-h-[44px] flex items-center";
      ...
      <div className="w-full px-4 py-2 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="ml-1 p-3 rounded-xl text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center"
          >
